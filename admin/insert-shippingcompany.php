...
require './class/myclass.php';
 ...
 $Contact=mysqli_real_escape_string($conn, $_POST['Contact']);
  ...
  $qry = "INSERT INTO `tbl_shippingcompany`(`Shipping_name`,`Address`, `Contact`,`Area_id`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Shipping_name}','{$Address}','{$Contact}','{$Area_id}','{$is_active}','{$is_delete}','{$insert_datetime}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">shippingcompany</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active"> shipping comapny insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-shippingcompany.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Shipping_name</label>
                      <div class="col-sm-6">
                          <input type="text" name='Shipping_name'class="form-control" required="true">
                      </div>
                    </div>
                        <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="number" name='Contact'class="form-control" required="true">
                      </div>
                    </div>
