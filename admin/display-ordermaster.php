    ...
    <body>
        <div class="be-wrapper">
            ...
            <div class="be-content">
                <div class="page-head">
                    <h2 class="page-head-title">DISPLAY ordermaster</h2>
                    <ol class="breadcrumb page-head-nav">
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Tables</a></li>
                        <li class="active">display ordermaster</li>
                    </ol>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-default panel-table">
                                <div class="panel-heading"> Display ordermaster
                                ...
                                <div class="panel-body">
                                    ...
                                    <table  class="table table-striped table-hover table-fw-widget">
                                        ...
                                        if (isset($_GET['id'])) {
                                            $id = $_GET['id'];
                                            $qry3 = "delete from tbl_ordermaster where Order_Id='{$id}'";
...
//                                                header("location:disamenity.php");
                                                ...
                                                echo "<script>
                                            window.location = 'display-ordermaster.php';
                                        </script>";
                                            }
                                        }
    ...
    INNER JOIN `tbl_ordermaster` 
        ON (`tbl_user`.`User_id` = `tbl_ordermaster`.`User_id`)";
                                        ...
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            echo "<td><a href='invoice.php?oid={$row['Order_Id']}'>Invoice</a> | <a href='?id=$row[0]'><i class='mdi mdi-delete' aria-hidden='true'></i></a> </td>";
