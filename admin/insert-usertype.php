...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_usertype`(`User_type`,`Company_code`,`is_active`,`is_delete`) VALUES"
          . " ('{$User_type}','{$company_code}','{$is_active}','{$is_delete}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title"> insert usertype</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">usertype insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-usertype.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name='User_type'class="form-control" required="true">
                      </div>
                    </div>
