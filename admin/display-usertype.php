  ...
  <body>
    <div class="be-wrapper">
      ...
      ?>
        ...
        <div class="page-head">
          <h2 class="page-head-title">DISPLAY usertype</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Tables</a></li>
            <li class="active">display usertype</li>
          </ol>
          <a href="insert-usertype.php" class="btn btn-primary" style="float: right">Add</a>
        </div>
        <div class="main-content container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading"> Display usertype
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $qry3 = "delete from tbl_usertype where User_type_id='{$id}'";
...
//                                                header("location:disamenity.php");
        ...
        echo "<script>
                                            window.location = 'display-usertype.php';
                                        </script>";
    }
}
...
$result = mysqli_query($conn,$qry);
 while ($row = mysqli_fetch_array($result)){
    ...
    echo "<td><a href='edit-usertype.php?eid={$row['User_type_id']}'><i class='mdi mdi-edit' aria-hidden='true'></i></a> || <a href='?id=$row[0]'><i class='mdi mdi-delete' aria-hidden='true'></i></a> </td>";
