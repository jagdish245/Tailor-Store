...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_product_material`(`Company_code`,`Pro_mat_name`,`is_active`,`is_delete`) VALUES"
          . " ('{$company_code}','{$Pro_mat_name}','{$is_active}','{$is_delete}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">productmaterial</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active"> productmaterial insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-productmaterial.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        ...
                        <div class="form-group">
                      <label class="col-sm-3 control-label">Product Material</label>
                      <div class="col-sm-6">
                          <input type="text" name='Pro_mat_name'class="form-control" required="true">
                      </div>
                    </div>
