...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_product_images`(`Pro_id`,`Image_url`,`is_active`,`is_delete`) VALUES"
          . " ('{$Pro_id}','{$Image_url}','{$is_active}','{$is_delete}')";
      ...
      <div class="be-content">
        <div class="page-head">
          ...
          <ol class="breadcrumb page-head-nav">
            ...
            <li class="active"> colour insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-productimages.php" class="btn btn-primary" style="float: right">Display</a>
