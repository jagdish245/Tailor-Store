...
if(!isset($_GET['eid'])){
   header("location:display-colour.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_color where Color_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_color` set `Color_name`='{$Color_name}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Color_id='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-colour.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT colour</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit colour</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Color Title</label>
                      <div class="col-sm-6">
                        <input type="name"  value="<?php echo $edit_details['Color_name']; ?>" placeholder="Enter Color name" class="form-control" name="Color_name">
                      </div>
                    </div>
