...
$edit_query = mysqli_query($conn, "select * from tbl_city where City_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_city` set `City_name`='{$City_name}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where City_id='{$eid}'";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT city</h2>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="name"  value="<?php echo $edit_details['City_name']; ?>" placeholder="Enter City name" class="form-control" name="City_name">
                      </div>
                    </div>
