  ...
  <body>
    <div class="be-wrapper">
      ...
      ?>
        ...
        <div class="page-head">
          <h2 class="page-head-title">Display Feedback</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Tables</a></li>
            <li class="active">display feedback</li>
          </ol>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading"> Display feedback
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $qry3 = "delete from tbl_feedback where Feedback_id='{$id}'";
...
//                                                header("location:disamenity.php");
        ...
        echo "<script>
                                            window.location = 'display-feedback.php';
                                        </script>";
    }
}
...
FROM
    ...
    INNER JOIN `tbl_product` 
        ON (`tbl_feedback`.`Product_id` = `tbl_product`.`Product_id`)
    INNER JOIN `tbl_user` 
        ON (`tbl_feedback`.`User_id` = `tbl_user`.`User_id`);";
