...
require './class/myclass.php';
    ...
    $Sub_catimgurl= mysqli_real_escape_string($conn,$_FILES['Sub_cat_imgurl']['name']);
  ...
  $qry = "INSERT INTO `tbl_subcategory`(`Sub_cat_name`,`cat_id`,`Sub_cat_imgurl`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Sub_cat_name}','{$cat_id}','{$Sub_catimgurl}','{$is_active}','{$is_delete}','{$insert_datetime}')";
   ...
   if($result){
      move_uploaded_file($_FILES['Sub_cat_imgurl']['tmp_name'],"./upload/".$Sub_catimgurl);
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">subcategory</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">subcategory insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-subcategory.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    <form method="post" style="border-radius: 0px;" enctype="multipart/form-data" class="form-horizontal group-border-dashed">
                      ...
                      <div class="col-sm-6">
                          <input type="name" name='Sub_cat_name' class="form-control" >
                      </div>
                    </div>
                      ...
                      <div class="col-sm-6">
                          <input type="file" name='Sub_cat_imgurl'class="form-control">
                      </div>
                    </div>
