...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_area`(`Area_name`,`City_id`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Area_name}','{$City_id}','{$is_active}','{$is_delete}','{$insert_datetime}')";
      ...
      <div class="be-content">
        <div class="page-head">
          ...
          <ol class="breadcrumb page-head-nav">
            ...
            <li class="active">admin insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-area.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="name" name='Area_name'class="form-control" required="true">
                      </div>
                    </div>
                        <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <?php
                        $sql = mysqli_query($conn,"SELECT * From  tbl_city") or die(mysqli_error($conn));
