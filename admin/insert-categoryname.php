...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_category`(`cat_name`,`cat_imgurl`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$cat_name}','{$cat_imgurl}','{$is_active}','{$is_delete}','{$insert_datetime}')";
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-categoryname.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    <form method="post" style="border-radius: 0px;" enctype="multipart/form-data" class="form-horizontal group-border-dashed">
                      ...
                      <div class="col-sm-6">
                          <input type="name" name='cat_name'class="form-control" required="true">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-6">
                          <input type="file" name='cat_imgurl'class="form-control">
                      </div>
                    </div>
