...
require './class/myclass.php';
 ...
 $Area_id=mysqli_real_escape_string($conn,$_POST['Area_id']);
  ...
  $qry = "INSERT INTO `tbl_user`(`User_name`,`Dob`, `Gender`,`Email`,`Password`,`phn_no`,`User_type_id`,`Address`,`Area_id`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$User_name}','{$Dob}','{$Gender}','{$Email}','{$Password}','{$phn_no}','{$User_type_id}','{$Address}','{$Area_id}','{$is_active}','{$is_delete}','{$insert_datetime}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">insert user</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active"> user insert</li>
          </ol>
        </div>
