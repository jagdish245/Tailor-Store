...
if(!isset($_GET['eid'])){
   header("location:display-size.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_size where Size_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_size` set `Size`='{$Size}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Size_id='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-size.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT size</h2>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text"  value="<?php echo $edit_details['Size']; ?>" placeholder="Enter Size" class="form-control" name="Size">
                      </div>
                    </div>
