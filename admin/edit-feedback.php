...
$edit_query = mysqli_query($conn, "select * from tbl_feedback where Feedback_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_feedback` set `Product_id`='{$Product_id}',`User_id`='{$User_id}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Feedback_id='{$eid}'";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT feedback</h2>
                ...
                <div class="panel-body">
                   ...
                   <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        ...
                        echo '<select name="Product_id"  class="form-control1">';
