  ...
  <body>
    <div class="be-wrapper">
      ...
      ?>
        ...
        <div class="page-head">
          <h2 class="page-head-title">DISPLAY orderdetails</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Tables</a></li>
            <li class="active">display order</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading"> Display order
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $qry3 = "delete from tbl_orderdetails where Order_id='{$id}'";
...
//                                                header("location:disamenity.php");
        ...
        echo "<script>
                                            window.location = 'display-orderdetails.php';
                                        </script>";
    }
}
...
FROM
    ...
    INNER JOIN `tbl_product` 
        ON (`tbl_orderdetails`.`Pro_id` = `tbl_product`.`Product_id`);";
