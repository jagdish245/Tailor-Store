...
<!--                  <li><a href="#"><span class="icon mdi mdi-face"></span> Account</a></li>
                  ...
                  <li><a href="changepasswordadmin.php"><span class="icon mdi mdi-settings"></span>Change Password</a></li>
                  <li><a href="logout.php"><span class="icon mdi mdi-power"></span>Logout</a></li>
                </ul>
              </li>
            </ul>
            <div class="page-title"><a href="index.php"><i class="icon mdi mdi-home"></i><span> Dashboard</span></a></div>
