...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_company`(`company_code`,`Name`,`Address`,`Area_id`,`Ph_no`,`Email`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$company_code}','{$Name}','{$Address}','{$Area_id}','{$Ph_no}','{$Email}','{$is_active}','{$is_delete}','{$insert_datetime}')";
      ...
      <div class="be-content">
        <div class="page-head">
          ...
          <ol class="breadcrumb page-head-nav">
            ...
            <li class="active">company insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-company.php" class="btn btn-primary" style="float: right">Display</a>
