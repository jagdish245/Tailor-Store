...
if(!isset($_GET['eid'])){
   header("location:display-orderstatus.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_orderstatus where Status_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_orderstatus` set `Status`='{$Status}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Status_id='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-orderstatus.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT orderstatus</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit orderstatus</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    <form method="post" style="border-radius: 0px;" class="form-horizontal group-border-dashed">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name='Status'class="form-control" required="true" value="<?php echo $edit_details['Status']; ?>" >
                      </div>
                    </div>
