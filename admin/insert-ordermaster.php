...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_ordermaster`(`Order_date`,`User_id`,`Shipping_id`,`Status_id`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Order_date}','{$User_id}','{$Shipping_id}','{$Status_id}','{$is_active}','{$is_delete}','{$insert_datetime}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">ordermaster</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active"> ordermaster insert</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="date" name='Order_date'class="form-control" required="true">
                      </div>
                    </div>
