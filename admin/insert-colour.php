...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_color`(`Color_name`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Color_name}','{$is_active}','{$is_delete}','{$insert_datetime}')";
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-colour.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name='Color_name'class="form-control" required="true">
                      </div>
                    </div>
