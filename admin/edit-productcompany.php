...
if(!isset($_GET['eid'])){
   header("location:display-productcompany.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_productcompany where product_company_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_productcompany` set `Company_code`='{$Company_code}',`Company_name`='{$Company_name}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where product_company_id='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-productcompany.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT productcompany</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit productcompany</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="number"  value="<?php echo $edit_details['company_code']; ?>" placeholder="Enter company code" class="form-control" name="Company_code">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-6">
                        <input type="name"  value="<?php echo $edit_details['Company_name']; ?>" placeholder="Enter Company name" class="form-control" name="Company_name">
                      </div>
                    </div>
