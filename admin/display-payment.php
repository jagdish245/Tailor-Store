  ...
  <body>
    <div class="be-wrapper">
      ...
      ?>
        ...
        <div class="page-head">
          <h2 class="page-head-title">DISPLAY payment</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Tables</a></li>
            <li class="active">display payment</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading"> Display payment
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $qry3 = "delete from tbl_payment where Payment_id='{$id}'";
...
//                                                header("location:disamenity.php");
        ...
        echo "<script>
                                            window.location = 'display-payment.php';
                                        </script>";
    }
}
...
FROM
    ...
    INNER JOIN `tbl_ordermaster` 
        ON (`tbl_payment`.`Order_id` = `tbl_ordermaster`.`Order_Id`);";
...
$result = mysqli_query($conn,$qry);
 while ($row = mysqli_fetch_array($result)){
    ...
    echo "<td><a href='edit-payment.php?eid={$row['Payment_id']}'><i class='mdi mdi-edit' aria-hidden='true'></i></a> || <a href='?id=$row[0]'><i class='mdi mdi-delete' aria-hidden='true'></i></a> </td>";
