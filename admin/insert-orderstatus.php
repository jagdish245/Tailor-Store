...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_orderstatus`(`Status`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Status}','{$is_active}','{$is_delete}','{$insert_datetime}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">order status</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active"> order status insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-orderstatus.php" class="btn btn-primary" style="float: right">Display</a>
