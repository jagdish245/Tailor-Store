...
require './class/myclass.php';
 ...
 $Company_code =mysqli_real_escape_string($conn, $_POST['company_code']);
  ...
  $qry = "INSERT INTO `tbl_productcompany`(`company_code`,`Company_name`,`is_active`,`is_delete`) VALUES"
          . " ('{$Company_code}','{$Company_name}','{$is_active}','{$is_delete}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title"> insert companyproduct</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">companyproduct insert</li>
          </ol>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                  <a href="display-productcompany.php" class="btn btn-primary" style="float: right">Display</a>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="number" name='company_code'class="form-control" required="true">
                      </div>
                    </div>
                        <div class="form-group">
                      <label class="col-sm-3 control-label">Company Name</label>
                      <div class="col-sm-6">
                          <input type="name" name='Company_name'class="form-control" required="true">
                      </div>
                    </div>
