...
if(!isset($_GET['eid'])){
   header("location:display-categoryname.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_category where cat_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
   ...
   $cat_imgurl = mysqli_real_escape_string($conn,$_FILES['cat_imgurl']['name']);
  ...
  $qry = "update `tbl_category` set `cat_name`='{$cat_name}',`cat_imgurl`='{$cat_imgurl}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where cat_id='{$eid}'";
   ...
   if($result){
       move_uploaded_file($_FILES['cat_imgurl']['tmp_name'],"./upload/".$cat_imgurl);
     echo "<script>alert('Record updated');window.location='display-categoryname.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT categoryname</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit categoryname</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="name"  value="<?php echo $edit_details['cat_name']; ?>" placeholder="Enter cat name" class="form-control" name="cat_name">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-6">
                          <input type="file"  value="<?php echo $edit_details['cat_imgurl']; ?>" placeholder="Enter cat imgurl" class="form-control" name="cat_imgurl">
                      </div>
                    </div>
