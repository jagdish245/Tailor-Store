...
$edit_query = mysqli_query($conn, "select * from tbl_orderdetails where Order_id='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
  ...
  $qry = "update `tbl_orderdetails` set `Pro_id`='{$Pro_id}',`Qty`='{$Qty}',`Price`='{$Price}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Order_id='{$eid}'";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT orderdetails</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit orderdetails</li>
          </ol>
        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        ...
                        echo '<select name="Pro_id"  class="form-control1">';
                             while ($row = $sql->fetch_array())
                                        {
                                             echo "<option value='". $row['Pro_id'] ."'>" .$row['Product_name'] ."</option>" ;
                                        }
                         echo "</select>" ;
                        ?>
                    </div>
