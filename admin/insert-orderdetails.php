...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_orderdetails`(`Pro_id`,`Qty`,`Price`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Pro_id}','{$Qty}','{$Price}','{$is_active}','{$is_delete}','{$insert_datetime}')";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">orderdetails</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">orderdetails insert</li>
          </ol>
        </div>
