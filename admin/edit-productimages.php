...
if(!isset($_GET['eid'])){
   header("location:display-productimages.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_product_images where Pro_imageid='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
    ...
    $Image_url =mysqli_real_escape_string($conn, $_FILES['Image_url']['name']);
  ...
  $qry = "update `tbl_product_images` set `Pro_id`='{$Pro_id}',`Image_url`='{$Image_url}',`is_active`='{$is_active}',`is_delete`='{$is_delete}' where Pro_imageid='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-productimages.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT productimages</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit productimages</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-3 control-label">Pro_id</label>
                      <div class="col-sm-8">
                        <?php
                        $sql = mysqli_query($conn,"SELECT * From  tbl_product") or die(mysqli_error($conn));
                         $row = mysqli_num_rows($sql);
                        echo '<select name="Pro_id"  class="form-control">';
                        ...
                        <div class="form-group">
                      <label class="col-sm-3 control-label">Image_url</label>
                      <div class="col-sm-6">
                          <input type="file" name='Image_url'class="form-control" required="true">
                      </div>
                    </div>
<!--                         <div class="form-group">
