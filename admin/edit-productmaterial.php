...
if(!isset($_GET['eid'])){
   header("location:display-productmaterial.php");
}
$eid = $_GET['eid'];

$edit_query = mysqli_query($conn, "select * from tbl_product_material where Mat_codeid='{$eid}'");
$edit_details = mysqli_fetch_array($edit_query);
    ...
    $Pro_mat_name = mysqli_real_escape_string($conn,$_POST['Pro_mat_name']);
   $is_active =1;
    $is_delete = 0;
   
    $insert_datetime = date('Y-m-d h:i:s');
   
  $qry = "update `tbl_product_material` set `Company_code`='{$company_code}',`Pro_mat_name`='{$Pro_mat_name}',`is_active`='{$is_active}',`is_delete`='{$is_delete}',`insert_datetime`='{$insert_datetime}' where Mat_codeid='{$eid}'";
   ...
   if($result){
     echo "<script>alert('Record updated');window.location='display-productmaterial.php';</script>";
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">EDIT productmatetial</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="#">Home</a></li>
            <li><a href="#">Forms</a></li>
            <li class="active">edit productmaterial</li>
          </ol>
        </div>
                ...
                <div class="panel-body">
                    <form method="post" style="border-radius: 0px;" enctype="multipart/form-data" class="form-horizontal group-border-dashed">
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="number" name='Company_code'class="form-control" required="true" value="<?php echo $edit_details['Company_code']; ?>">
                      </div>
                    </div>
                      ...
                      <div class="col-sm-6">
                          <input type="text" name='Pro_mat_name'class="form-control" required="true" value="<?php echo $edit_details['Pro_mat_name']; ?>">
                      </div>
                    </div>
<!--                         <div class="form-group">
