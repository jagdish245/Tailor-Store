...
require './class/myclass.php';
  ...
  $qry = "INSERT INTO `tbl_feedback`(`Product_id`,`User_id`,`is_active`,`is_delete`,`insert_datetime`) VALUES"
          . " ('{$Product_id}','{$User_id}','{$is_active}','{$is_delete}','{$insert_datetime}')";
      ...
      <div class="be-content">
        <div class="page-head">
          ...
          <ol class="breadcrumb page-head-nav">
            ...
            <li class="active">feedback insert</li>
          </ol>
        </div>
